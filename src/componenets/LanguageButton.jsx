...
function LanguageButton() {
    ...
    dispatch(changeValue(selectedId));
    }
  return (
//<div className="flex flex-col gap-2 p-4 bg-gray-900 rounded-t-lg border-b border-gray-700">
      ...
      >
        {monacoLanguages.map((one) => (
           <option key={one.id} id={one.id} value={one.id} className="bg-gray-800">
